# Form implementation generated from reading ui file 'C:\Users\PC\PycharmProjects\PythonProject33chuong5\banmoi\thanhcong6.ui'
#
...
"}\n"
"\n"
"QFrame#campaignCard, QFrame#successCard {\n"
"    background: #F9EFF3;\n"
...
"}\n"
"\n"
"QLabel#sectionTitle, QLabel#ownerTitle {\n"
"    color: #442C3E;\n"
"    font-size: 16px;\n"
"    font-weight: 700;\n"
"}\n"
...
"}")
        ...
        self.successCard = QtWidgets.QFrame(parent=self.bodyWidget)
        self.successCard.setMinimumSize(QtCore.QSize(0, 180))
        self.successCard.setMaximumSize(QtCore.QSize(480, 220))
        self.successCard.setObjectName("successCard")
        self.successLayout = QtWidgets.QVBoxLayout(self.successCard)
        self.successLayout.setContentsMargins(20, 20, 20, 20)
        self.successLayout.setObjectName("successLayout")
        self.successTitle = QtWidgets.QLabel(parent=self.successCard)
        self.successTitle.setObjectName("successTitle")
        self.successLayout.addWidget(self.successTitle)
        spacerItem4 = QtWidgets.QSpacerItem(20, 10, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.successLayout.addItem(spacerItem4)
        self.successIcon = QtWidgets.QLabel(parent=self.successCard)
        self.successIcon.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.successIcon.setObjectName("successIcon")
        self.successLayout.addWidget(self.successIcon)
        self.successText = QtWidgets.QLabel(parent=self.successCard)
        self.successText.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.successText.setObjectName("successText")
        self.successLayout.addWidget(self.successText)
        self.thankText = QtWidgets.QLabel(parent=self.successCard)
        self.thankText.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.thankText.setWordWrap(True)
        self.thankText.setObjectName("thankText")
        self.successLayout.addWidget(self.thankText)
        spacerItem5 = QtWidgets.QSpacerItem(20, 10, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.successLayout.addItem(spacerItem5)
        self.verticalLayout.addWidget(self.successCard)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Donarity - Thành công 6"))
...
"Đồng hành tái hòa nhập gia đình và xã hội"))
        ...
        self.successTitle.setText(_translate("MainWindow", "Quyên góp"))
        self.successIcon.setText(_translate("MainWindow", "✔"))
        self.successText.setText(_translate("MainWindow", "Quyên góp thành công"))
        self.thankText.setText(_translate("MainWindow", "Cảm ơn bạn đã góp phần bảo vệ và chở che cho trẻ em yếu thế."))
