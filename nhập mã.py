...
class DonationPage(QWidget):
    ...
    def build_ui(self):
        ...
        donation_layout.setContentsMargins(20, 14, 18, 14)
        donation_layout.setSpacing(16)

        left_donation = QVBoxLayout()
        left_donation.setContentsMargins(0, 0, 0, 0)
        ...
        code_title = QLabel("Mã giao dịch")
        code_title.setStyleSheet("font-size: 15px;")
        left_donation.addWidget(code_title, alignment=Qt.AlignmentFlag.AlignHCenter)

        self.code_input = QLineEdit()
        self.code_input.setPlaceholderText("Nhập mã giao dịch")
        self.code_input.setFixedWidth(170)
        self.code_input.setFixedHeight(44)
        left_donation.addWidget(self.code_input, alignment=Qt.AlignmentFlag.AlignHCenter)
        ...
        left_donation.addStretch()

        donation_layout.addLayout(left_donation)

        self.qr_label = ImageLabel(140, 140)
