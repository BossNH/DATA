# Form implementation generated from reading ui file 'C:\Users\PC\PycharmProjects\PythonProject33chuong5\banmoi\xacminh6.ui'
#
...
"}\n"
"\n"
"QFrame#campaignCard, QFrame#verifyCard {\n"
"    background: #F9EFF3;\n"
...
"}")
        ...
        self.verifyCard = QtWidgets.QFrame(parent=self.bodyWidget)
        self.verifyCard.setMinimumSize(QtCore.QSize(0, 180))
        self.verifyCard.setMaximumSize(QtCore.QSize(480, 200))
        self.verifyCard.setObjectName("verifyCard")
        self.verifyLayout = QtWidgets.QVBoxLayout(self.verifyCard)
        self.verifyLayout.setContentsMargins(20, 20, 20, 20)
        self.verifyLayout.setObjectName("verifyLayout")
        self.verifyTitle = QtWidgets.QLabel(parent=self.verifyCard)
        self.verifyTitle.setObjectName("verifyTitle")
        self.verifyLayout.addWidget(self.verifyTitle)
        spacerItem4 = QtWidgets.QSpacerItem(20, 10, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.verifyLayout.addItem(spacerItem4)
        self.verifyIcon = QtWidgets.QLabel(parent=self.verifyCard)
        self.verifyIcon.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.verifyIcon.setObjectName("verifyIcon")
        self.verifyLayout.addWidget(self.verifyIcon)
        self.verifyText = QtWidgets.QLabel(parent=self.verifyCard)
        self.verifyText.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.verifyText.setObjectName("verifyText")
        self.verifyLayout.addWidget(self.verifyText)
        spacerItem5 = QtWidgets.QSpacerItem(20, 10, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.verifyLayout.addItem(spacerItem5)
        self.verticalLayout.addWidget(self.verifyCard)
...
"Đồng hành tái hòa nhập gia đình và xã hội"))
        ...
        self.verifyTitle.setText(_translate("MainWindow", "Quyên góp"))
        self.verifyIcon.setText(_translate("MainWindow", "🕒"))
