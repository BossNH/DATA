...
"")
        ...
        self.verticalLayout_nav = QtWidgets.QVBoxLayout()
        self.verticalLayout_nav.setContentsMargins(12, 10, 12, 10)
        ...
        self.horizontalLayout_nav = QtWidgets.QHBoxLayout(self.navFrame)
        self.horizontalLayout_nav.setContentsMargins(18, 10, 18, 10)
        self.horizontalLayout_nav.setSpacing(18)
        self.horizontalLayout_nav.setObjectName("horizontalLayout_nav")
        self.logoLayout_nav = QtWidgets.QHBoxLayout()
        self.logoLayout_nav.setSpacing(8)
        self.logoLayout_nav.setObjectName("logoLayout_nav")
        ...
        self.logoLayout_nav.addWidget(self.logoImage)
        self.brandLayout_nav = QtWidgets.QVBoxLayout()
        self.brandLayout_nav.setSpacing(0)
        self.brandLayout_nav.setObjectName("brandLayout_nav")
        self.brandTitle = QtWidgets.QLabel(parent=self.navFrame)
        self.brandTitle.setObjectName("brandTitle")
        self.brandLayout_nav.addWidget(self.brandTitle)
        self.brandSubtitle = QtWidgets.QLabel(parent=self.navFrame)
        self.brandSubtitle.setObjectName("brandSubtitle")
        self.brandLayout_nav.addWidget(self.brandSubtitle)
        self.logoLayout_nav.addLayout(self.brandLayout_nav)
        self.horizontalLayout_nav.addLayout(self.logoLayout_nav)
        self.menuLayout_nav = QtWidgets.QHBoxLayout()
        self.menuLayout_nav.setSizeConstraint(QtWidgets.QLayout.SizeConstraint.SetFixedSize)
        self.menuLayout_nav.setContentsMargins(0, -1, 90, -1)
        self.menuLayout_nav.setSpacing(10)
        self.menuLayout_nav.setObjectName("menuLayout_nav")
        ...
        self.menuLayout_nav.addWidget(self.btnHome)
        ...
        self.menuLayout_nav.addWidget(self.btnCreate)
        ...
        self.menuLayout_nav.addWidget(self.btnFollow)
        ...
        self.menuLayout_nav.addWidget(self.btnPublic)
        self.horizontalLayout_nav.addLayout(self.menuLayout_nav)
...
"")
        ...
        self.btnNotify.setGeometry(QtCore.QRect(0, 0, 40, 40))
        self.btnNotify.setMaximumSize(QtCore.QSize(40, 40))
        ...
        self.btnSetting.setMaximumSize(QtCore.QSize(40, 40))
        ...
        self.horizontalLayout_nav.addWidget(self.rightActionsWidget)
        self.verticalLayout_nav.addWidget(self.navFrame)
        self.verticalLayout_2.addLayout(self.verticalLayout_nav)
        ...
        self.amountLayout.addItem(spacerItem)
        ...
        self.avatarLabel.setPixmap(QtGui.QPixmap("C:\\Users\\PC\\PycharmProjects\\PythonProject33chuong5\\banmoi\\avt5"))
        ...
        self.donateLeftLayout.addItem(spacerItem2)
        ...
        self.qrLabel.setPixmap(QtGui.QPixmap("C:\\Users\\PC\\PycharmProjects\\PythonProject33chuong5\\banmoi\\qr5"))
