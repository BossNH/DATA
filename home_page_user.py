...
"}")
        ...
        self.logoIcon.setMinimumSize(QtCore.QSize(34, 34))
        self.logoIcon.setMaximumSize(QtCore.QSize(34, 34))
        self.logoIcon.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.logoIcon.setStyleSheet("font-size: 18px; background: transparent;")
        ...
        self.verticalLayout_hero.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_hero.setSpacing(0)
        ...
        self.heroImage.setPixmap(QtGui.QPixmap("C:\\Users\\ADMIN\\PycharmProjects\\DoAnKTLT\\chatbot_hero_crop.png"))
        self.heroImage.setScaledContents(True)
        self.heroImage.setObjectName("heroImage")
        self.verticalLayout_hero.addWidget(self.heroImage)
